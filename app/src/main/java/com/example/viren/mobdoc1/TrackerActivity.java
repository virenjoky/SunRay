...
public class TrackerActivity extends AppCompatActivity {
        ...
        mClient = new GoogleApiClient.Builder(this)
                ...
                .enableAutoManage(this, 0, new GoogleApiClient.OnConnectionFailedListener() {
                    ...
                    public void onConnectionFailed(ConnectionResult result) {
                        ...
                        Snackbar.make(
                                //com.example.viren.mobdoc1.TrackerActivity.this.findViewById(R.id.tracker_activity),
                                com.example.viren.mobdoc1.TrackerActivity.this.findViewById(R.id.step_tracker),
    ...
    private class InsertAndVerifyDataTask extends AsyncTask<Void, Void, Void> {
        protected Void doInBackground(Void... params) {
            ...
            DataReadRequest readRequest1 = queryFitnessData(startTime1,endTime1);
